...
var ready = function() {
  ...
  $("#phone_sub_department_id").change(function() {
    ...
    $.getJSON( '/sub_departments/' + sdept + '/default_dialling_right.json', function(data) {
      for (var x in data) {
        $("#phone_dialling_right_id option[value='"+data[x].default_dialling_right_id+"']").attr('selected', 'selected');
       };
     });
  });
