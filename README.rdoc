...
* Files to clean up and remove employer identifying content
 - app/views/layouts/application.html.erb:
 <%= image_tag("logo_LBS.gif", :width => 64, :height => 64) %>
 ...
 - db/migrate/20140228213722_create_buildings.rb:
 t.string :name, :null => false, :default => 'LBS building', :limit => 32
